...
class QuizScifi extends StatefulWidget {
  final String dificuldade;
  final String genero;
  const QuizScifi(this.dificuldade, this.genero);

  @override
  _QuizScifiState createState() => _QuizScifiState();
}

class _QuizScifiState extends State<QuizScifi> {
  int questionIndex = 0;
  int pontuacao = 0;
